# 🌸 ONG Florescer - Sistema de Design Completo
...
Este projeto apresenta um sistema de design completo e moderno, desenvolvido com **HTML5** e **CSS3**, seguindo as melhores práticas de desenvolvimento front-end.

### Design System Características

- **Variáveis CSS customizadas** para manutenção consistente
- **Paleta de cores temática** (8+ cores) inspirada na natureza e flores
- **Tipografia hierárquica** com 9 tamanhos de fonte
- **Sistema de espaçamento modular** (8px, 16px, 24px, 32px, 48px, 64px, etc.)
- **Componentes reutilizáveis** e modulares

### Páginas do Site
- **Home (index.html)**: Página inicial com apresentação da ONG
- **Projetos Sociais (projetos.html)**: Informações sobre voluntariado e doações  
- **Cadastro (cadastro.html)**: Formulário de cadastro para voluntários
...
1. Abra qualquer arquivo HTML da pasta `pages/` em um navegador moderno
2. Para melhor experiência, use um servidor local
3. O sistema CSS modular carrega automaticamente via `@import` no `main.css`
4. Teste a responsividade redimensionando a janela
5. **Teste o menu hambúrguer**: Use F12 > modo dispositivo ou redimensione para mobile
6. Experimente o formulário e validações HTML5
7. Teste a navegação hover nos dropdowns (desktop)
...
Este projeto demonstra um sistema de design profissional desenvolvido exclusivamente com **HTML5 e CSS3**, sem dependência de JavaScript, seguindo as melhores práticas de desenvolvimento front-end moderno.
