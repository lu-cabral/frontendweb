...
const templates = {
    home: `
        <section class="hero">
            <div class="container">
                <h1 class="hero-title">Transformando Vidas com Carinho</h1>
                ...
                <div class="flex justify-center gap-4 mt-4">
                    <button onclick="navigate('projetos.html')" class="btn btn-secondary btn-lg">Seja Voluntário</button>
                    <button onclick="document.getElementById('historia').scrollIntoView()" class="btn btn-outline btn-lg">Nossa História</button>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            <div class="container">
                <h2 class="section-title text-center mb-8">Nosso Impacto</h2>
                <div class="grid grid-cols-4 gap-4 text-center">
                    <div class="card">
                        <div class="card-body">
                            <div style="font-size: 2.5rem; font-weight: bold; color: var(--color-primary);">150+</div>
                            <p class="text-sm text-neutral-600">Idosos Atendidos</p>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div style="font-size: 2.5rem; font-weight: bold; color: var(--color-primary);">45+</div>
                            <p class="text-sm text-neutral-600">Voluntários Ativos</p>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div style="font-size: 2.5rem; font-weight: bold; color: var(--color-primary);">12</div>
                            <p class="text-sm text-neutral-600">Casas de Repouso</p>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div style="font-size: 2.5rem; font-weight: bold; color: var(--color-primary);">500+</div>
